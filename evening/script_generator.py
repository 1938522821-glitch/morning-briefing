...
SECTION_PROMPTS = {
    "story": {
        ...
        "instruction": (
            ...
            "不要在故事里直接点明对应的概念名称——先把故事完整、生动地讲出来："
            "要有具体的人物、场景、情节和转折，故事本身要能独立成立、引人入胜。"
            "让故事在结尾处自然达到一个「恍然大悟」式的转折或顿悟时刻——"
            "但这个顿悟仍然只停留在故事的语境里，不要说出对应的概念名称；\n"
            "② 真实历史事件——挑一个有意思的真实历史事件（比如重大科学发现的曲折过程、"
            "工程或商业史上的经典案例、影响深远的决策失误等）。"
            "直接、坦然地讲述这个真实事件本身：可以直接说出事件、人物、时间、地点，"
            "按时间线还原关键人物的处境、决策和转折，像讲一段真实的历史故事一样自然展开，"
            "不需要伪装成寓言、也不需要刻意藏起身份制造悬念；\n"
            "③ 非虚构书籍里的故事——取材于一本有意思的纪实/科普/商业类书籍里的核心案例或故事，"
            "用讲故事的方式复述这个案例本身，先不点明书名/作者，"
            "结尾留一个「恍然大悟」式的顿悟钩子。\n"
    ...
    "reveal": {
        ...
        "instruction": (
            "承接上一段故事。\n"
            "- 如果上一段是①原创寓言（未点明概念），现在用通俗易懂的语言揭晓并解释"
            "这个故事对应的学术概念/理论，逐一说明故事里的人物、场景、情节、转折"
            "分别对应概念的哪些部分，让听众有「原来如此」的恍然大悟感；\n"
            "- 如果上一段是②真实历史事件（已经直接讲述了事件本身，无需再揭晓身份），"
            "现在不要重复「这是什么事件」，而是补充一些背景、后续发展，"
            "说明这件事留下了什么影响或教训；\n"
            "- 如果上一段是③书籍里的案例（未点明书名），现在点出这个案例出自哪本书"
            "（书名和作者），简单介绍一下这本书，再说明这个案例想说明的道理。\n"
            "无论哪种，都可以再延伸聊聊这对日常生活、工作、人际关系或异乡生活心态的启发，"
            "但不要说教，篇幅不需要很长。"
